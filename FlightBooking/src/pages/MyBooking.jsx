  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        "http://localhost:8080/api/flights/findbooking",
        {
          params: {
            flightNumber,
            passengerEmail,
        ...
        <div className="card ">
          <div className="card-content ">
            ...
            <form onSubmit={handleSearch} className="find-booking-form">
              ...
              <div className="buttonb d-flex justify-content-center">
                <button
            ...
            {booking && (
              <div className="booking-result">
                ...
                <p>
                  <strong>Departure Airport:</strong> {booking.departureAirport}
                </p>
                <p>
                ...
                <p>
                  <strong>Departure Time:</strong> {booking.departureTime}
                </p>
                <p>
                ...
                <p>
                  <strong>Passenger Email:</strong> {booking.passengerEmail}
                </p>
                <p>
