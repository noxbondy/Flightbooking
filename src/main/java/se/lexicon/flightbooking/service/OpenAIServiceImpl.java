...
public class OpenAIServiceImpl implements OpenAIService {
    ...
    public OpenAIServiceImpl(OpenAiChatModel openAiChatModel, OpenAiImageModel  openAiImageModel,
                             ...
                             OpenAiAudioSpeechModel openaiAudioSpeechModel,ChatMemory chatMemory) {
    ...
    @Override
    public Flux<String> processSimpleChatQueryWithStream(String query) {
    ...
    public String processSimpleChatQueryWithContext(String query) {
        ...
        Prompt prompt= Prompt.builder()
                ...
                .chatOptions(ChatOptions.builder().model("gpt-4.1-mini").temperature(0.3).build()).build();
    ...
    public String processImage(MultipartFile file) {
        ...
        if (file.getContentType() == null || !MimeTypeUtils.IMAGE_GIF.equals(file.getContentType())) {
            throw new IllegalArgumentException("File must be GIF");
        }
